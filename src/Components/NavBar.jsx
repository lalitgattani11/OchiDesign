...
export default function NavBar() {
  return (
    <Disclosure
      as="nav"
      className="bg-[#004D43] text-[#CDEA68] font-semibold font-neue fixed w-full z-50"
    >
      {({ open }) => (
        <>
                ...
                {navigation.map((item) => (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      classNames(
                        isActive
                          ? "border-b-[1px] border-zinc-400 font-bold"
                          : "hover:border-b-2 hover:border-zinc-400 font-medium",
                        "text-white px-3 py-2 text-base capitalize"
                      )
                    }
                  >
                    {item.name}
                ...
                <Disclosure.Button
                  ...
                  className={({ isActive }) =>
                    classNames(
                      ...
                      "block rounded-md px-3 py-2 text-base font-medium capitalize text-white"
                    )
                  }
                >
                  {item.name}
